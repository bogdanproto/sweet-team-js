...
<div class="recipe-card-btn-container">
<button class="recipe-card-btn modal-recipe-favorite-btn" type="button">${
      isFavorite ? 'Remove from' : 'Add to'
    } favorite</button>
    <button class="recipe-card-btn modal-recipe-rating-btn" type="button">Give a rating</button>
    </div>
       <div class="modal-rating">
    <button class="js-modal-rating-btn-close modal-recipe-close-btn" type="button">
    <svg class="modal-recipe-svg" width="20" height="20" xmlns="http://www.w3.org/2000/svg"><path d="M5.626 5.045a1.68 1.68 0 0 0-.583.59.864.864 0 0 0 .001.737c.056.112.985 1.07 2.809 2.898L10.579 12l-2.726 2.73c-1.824 1.828-2.753 2.786-2.809 2.898-.176.352-.085.733.255 1.073.34.34.721.431 1.073.255.112-.056 1.07-.985 2.898-2.809L12 13.421l2.73 2.726c1.828 1.824 2.786 2.753 2.898 2.809.352.176.733.085 1.073-.255.34-.34.431-.721.255-1.073-.056-.112-.985-1.07-2.809-2.898L13.421 12l2.726-2.73c1.824-1.828 2.753-2.786 2.809-2.898.176-.352.085-.733-.255-1.073-.34-.34-.721-.431-1.073-.255-.112.056-1.07.985-2.898 2.809L12 10.579 9.27 7.853C7.442 6.029 6.484 5.1 6.372 5.044a.884.884 0 0 0-.746.001" fill-rule="evenodd""/></svg>
</button>
    <form class="modal-form-rating">
      <div class="modal-form-rating-element">
      <p class="modal-form-rating-element-text">Rating</p>
      <div class="modal-form-rating-group">
      <p id="textrating">0.0</p>
      <div id="addrating"></div>
      </div>
      </div>
        <label class="modal-form-rating-label-email">
        <input
          class="modal-form-rating-input-email"
          type="email"
          name="email"
          id="rating_email"
      ...
      <button type="submit" class="modal-form-rating-btn btn">Send</button>
    </form>
    </div>
      </div>`;
  } else {
